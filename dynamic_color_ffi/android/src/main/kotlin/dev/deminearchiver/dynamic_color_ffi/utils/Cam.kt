...
package dev.deminearchiver.dynamic_color_ffi.utils

import androidx.annotation.Nullable
import dev.deminearchiver.dynamic_color_ffi.utils.CamUtils.intFromLstar
import dev.deminearchiver.dynamic_color_ffi.utils.CamUtils.lstarFromInt
import dev.deminearchiver.dynamic_color_ffi.utils.CamUtils.xyzFromInt
import dev.deminearchiver.dynamic_color_ffi.utils.HctSolver.solveToInt
...
internal class Cam(
  ...
  fun viewedInSrgb(): Int {
    return viewed(Frame.Companion.Default)
  }
  ...
  companion object {
    ...
    fun getInt(hue: Float, chroma: Float, lstar: Float): Int {
      return getInt(hue, chroma, lstar, Frame.Companion.Default)
    }
    ...
    fun fromInt(argb: Int): Cam {
      return fromIntInFrame(argb, Frame.Companion.Default)
    }
    ...
    private fun fromJch(j: Float, c: Float, h: Float): Cam {
      return fromJchInFrame(j, c, h, Frame.Companion.Default)
    }
    ...
    private fun getInt(hue: Float, chroma: Float, lstar: Float, frame: Frame): Int {
      ...
      var huePrime = hue
      if (frame == Frame.Companion.Default) {
